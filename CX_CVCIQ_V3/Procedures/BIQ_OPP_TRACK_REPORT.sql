CREATE OR REPLACE PROCEDURE cx_cvciq_v3.biq_opp_track_report (
...
--						 dbms_output.put_line('Inside cursor   '  );
            BEGIN
                ...
                lrec.changeinrevenuedollar := l_cur_opp_track_data(i).changeinrevenuedollar;
                lrec.changeinrevenuepercent := l_cur_opp_track_data(i).changeinrevenuepercent;
