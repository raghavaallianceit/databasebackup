CREATE TABLE cx_cvciq_v3.t_rp_report (
  "ID" NUMBER NOT NULL,
  ...
  CONSTRAINT "fk_report_group_id" FOREIGN KEY (report_group_id) REFERENCES cx_cvciq_v3.t_rp_report_group ("ID"),
  CONSTRAINT "fk_report_handler_id" FOREIGN KEY (report_handler_id) REFERENCES cx_cvciq_v3.t_rp_report_handler ("ID")
);