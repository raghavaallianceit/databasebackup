CREATE OR REPLACE PROCEDURE cx_cvciq_v3.test_topic_report (
                    ...
                    FROM
                        (
                            SELECT
                                ...
                                r.country         country,
                                CASE
                                    WHEN t.OPTIONAL_TOPIC IS NOT NULL
                                        THEN
                                        t.OPTIONAL_TOPIC
                                    ELSE t.topic
                                    END topic,
...
--                        AND p.bi_request_topic_activity_id = t.id
                        ) a
                        LEFT JOIN bi_request_presenter p 
                        ON
                        p.bi_request_topic_activity_id = a.topic_activity_id
